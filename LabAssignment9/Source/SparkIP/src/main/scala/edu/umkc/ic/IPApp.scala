...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("Electronics", "Clothes", "Restaurant", "Furniture", "Accesories", "Health", "Instruments", "Decoration")
  ...
  def main(args: Array[String]) {
    ...
    val ip = InetAddress.getByName("192.168.52.1").getHostName
