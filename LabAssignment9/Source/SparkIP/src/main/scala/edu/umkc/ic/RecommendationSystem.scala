...
object RecommendationSystem {
  ...
  def main(args: Array[String]) {
    ...
    val tags = List("Electronics", "Clothes", "Restaurant", "Furniture", "Accesories", "Health", "Instruments", "Decoration")
    ...
    val recoData = sc.textFile("instadata1/recommendation.txt")
    ...
    var i = 1
    println("Shopping recommended for you:")
